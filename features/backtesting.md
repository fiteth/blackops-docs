...
{% hint style="warning" %}
**Admin-only research tool.** Backtesting is not a subscriber feature.
{% endhint %}

Simulate how alert criteria performed against historical data.

## How It Works

Backtesting tests parameters against historical signals and wallet data. Results support research and do not guarantee future outcomes.
